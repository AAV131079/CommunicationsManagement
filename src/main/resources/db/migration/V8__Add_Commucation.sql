insert into CommunicationsManagement.communication (communication_id, create_time, booking_id, communication_type_id,
    user_id, description, content)
    values (1, NOW(), null, 1, 1, 'Массовая рассылка. Поздравление клиента. Уведомление об акции',
                            'С Новым годом вас спешу поздравить, пусть он подарит вам чудесные мгновения'),
