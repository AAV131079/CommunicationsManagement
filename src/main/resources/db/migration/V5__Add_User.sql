...
insert into CommunicationsManagement.usr (user_id, birth_date, create_time, first_name, last_name, password, update_time, user_name, department_id, social_media_id)
